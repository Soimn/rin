...
typedef enum Token_Kind
{
  ...
  Token__FirstBinary = TOKEN_KIND__BLOCK(4),
  ...
  Token__FirstAddLevel = TOKEN_KIND__BLOCK(5),
  ...
  Token__FirstCmpLevel = TOKEN_KIND__BLOCK(6),
  ...
  Token__FirstAddLevelAssignment = TOKEN_KIND__BLOCK(16 + 5),
  ...
  // NOTE: 16 + 6 is not used since there are no cmp assignment expressions

  Token__FirstLAndLevelAssignment = TOKEN_KIND__BLOCK(16 + 7),
  Token_LAndEQ = Token__FirstLAndLevelAssignment,         // &&=
  Token__PastLastLAndLevelAssignment,

  Token__FirstLOrLevelAssignment = TOKEN_KIND__BLOCK(16 + 8),
